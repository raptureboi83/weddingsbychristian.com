...
class ContactSectionWidget extends Widget implements HasForms
{
    ...
    public ?ContactSection $record = null;
        ...
        return $schema
            ...
            ->components([
                Section::make('Contact Section Content')
                    ->description('Manage the content shown on the Contact page.')
                    ->columnSpanFull()
                    ->schema([
