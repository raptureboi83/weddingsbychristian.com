...
<style>
    ...
    .page-vendors .vendor-logo-bg-white .vendor-logo {
        background: #fff;
    }

    .page-vendors .vendor-logo-bg-black .vendor-logo {
        background: #1a1a1a;
    }

    .page-vendors .vendor-name {
        text-align: center;
        font-size: 16px;
        font-weight: 500;
        color: var(--cool-gray);
    ...
    .page-vendors .vendor-website {
        text-align: center;
    }

    .page-vendors .vendor-website a {
        display: inline-block;
        font-family: 'Inter', sans-serif;
        font-size: 12px;
    ...
    .page-vendors .vendor-website a:hover {
        color: var(--cream);
        border-color: rgba(227, 218, 203, 0.3);
    }
                                ...
                                <div class="vendor-grid">
                                    @foreach ($category->vendors as $vendor)
                                        <div class="vendor-card">
                                            ...
                                            @if ($logoUrl)
                                                @php $logoBgClass = ($vendor->logo_bg ?? 'white') === 'black' ? 'vendor-logo-bg-black' : 'vendor-logo-bg-white'; @endphp
