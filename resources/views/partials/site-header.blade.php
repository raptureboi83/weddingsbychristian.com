@php
    ...
    $navItems = [
        ['label' => 'About', 'href' => $isHome = request()->routeIs('home') ? '#about' : url('/#about')],
        ['label' => 'Films', 'href' => route('films.index')],
...
<nav class="site-nav">
    <div class="container site-nav-inner">
        <a href="{{ $homeAnchor }}" class="site-brand">
            @if ($siteSettings->logo_image_path)
                <img src="{{ asset('storage/' . $siteSettings->logo_image_path) }}" alt="{{ $siteName }}">
            @else
