...
@section('page_css', asset('css/home.css'))

@php
    $siteName = $siteSettings->site_name ?: 'Weddings By Christian';

    $heroTitle = $heroSection?->title ?: 'Capturing Your Forever';
    $heroDescription = $heroSection?->description ?: 'A Love Story';
    $heroMedia = $heroSection?->background_media_path ? asset('storage/' . $heroSection->background_media_path) : null;
    ...
    $aboutImage = $aboutSection?->image_path ? asset('storage/' . $aboutSection->image_path) : null;
    $aboutVideo = $aboutSection?->video_path ? asset('storage/' . $aboutSection->video_path) : null;
    ...
    $footerLinks = array_filter([
        ['network' => 'facebook', 'url' => $siteSettings->footer_facebook_url],
        ['network' => 'instagram', 'url' => $siteSettings->footer_instagram_url],
        ['network' => 'youtube', 'url' => $siteSettings->footer_youtube_url],
        ['network' => 'tiktok', 'url' => $siteSettings->footer_tiktok_url],
